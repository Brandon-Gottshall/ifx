...
## Location
- Primary config: `~/.config/ifx/config.toml`
- Cache (future): `~/.cache/ifx/`
- State (future): `~/.local/share/ifx/`
...
themes = "~/.config/ifx/themes"
icons  = "~/.config/ifx/icons"
extensions = "~/.config/ifx/extensions"
```
