...
7) Dev test harness (ifx dev:tests) — Issue #7
8) Release + Homebrew tap automation — Issue #8

## GitHub Issue Links
- #1 https://github.com/Brandon-Gottshall/ifx/issues/1
- #2 https://github.com/Brandon-Gottshall/ifx/issues/2
- #3 https://github.com/Brandon-Gottshall/ifx/issues/3
- #4 https://github.com/Brandon-Gottshall/ifx/issues/4
- #5 https://github.com/Brandon-Gottshall/ifx/issues/5
- #6 https://github.com/Brandon-Gottshall/ifx/issues/6
- #7 https://github.com/Brandon-Gottshall/ifx/issues/7
- #8 https://github.com/Brandon-Gottshall/ifx/issues/8
...
Create the minimal registry data and implement `ifx theme list` from `registry/themes/<theme-name>/colors`.
...
Load `~/.config/ifx/config.toml` on startup and warn on missing/invalid config before falling back to defaults.
