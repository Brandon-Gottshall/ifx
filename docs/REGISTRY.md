...
## Overview
The registry is filesystem-first and human-readable. It lives in-repo under `registry/` and is the source of truth for what ifx can install. The MVP uses conventions instead of manifest files.
